...
pre_install_docker_compose(){
    ...
    read -p "(多久一次: 回车默认24小时进行一次):" ssrpanel_speedtest
    [ -z "${ssrpanel_speedtest}" ] && ssrpanel_speedtest=24
    echo
    echo "---------------------------"
...
config_docker(){
    ...
    echo "等待加载DOCKER配置文件"
    curl -L https://raw.githubusercontent.com/649974402/v2ray/master/docker-compose.yml > docker-compose.yml
